...
<div class="container">
  <h1 class="text h1 mb-3 mt-3">Administradores</h1>
...
<div class="col-auto mb-3 mt-3 align-items-center">
  <a href="cadastro_usuario.php"><button class="btn btn-warning">Cadastrar novo Administrador</button></a>
      ...
      <table class="table table-bordered border-dark">
        ...
        ?>
          <td>
            <a class="editButton" href="editar_adm.php?id_editar=<?php echo $contato['id'];?>">   
        ...
        <td>
            <?php
            $dados2 = $p->verificarAdmsExcluidos($contato['id']);
            if (!$dados2) { ?>
                <a id="deletar" onclick="return confirm('Tirar acesso desse administrador?');" href="buscar_adm.php?id=<?php echo $contato['id'].'&func=del' ?>"><button class="button">
  <svg
