...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="col-auto mb-3 mt-3 align-items-center">
            <a href="cadastro.php"><button class="btn btn-success-primary">Cadastrar novo ramal</button></a>
            <a href="cadastro_usuario.php"><button class="btn btn-warning">Cadastrar novo Administrador</button></a>
            <a href="../admin/buscar_adm.php"><button type="submit" class="btn btn-secondary">Lista de
                    Administradores</button></a>
        </div>
        <!-- barra de busca  --->
        <form class="row row-cols-lg-auto g-col-6 align-items-center" method="POST" action="buscar.php">
       ...
       ?>
        ...
        <nav aria-label="...">
            <ul class="pagination justify-content-center">
                <li class="page-item">
                    <a class="btn btn-success-primary" href="<?php echo 'dashboard.php?pagina=1' ?>">Primeira</a>
                </li>
              ...
              for($pag_ant = $pagina - $max_links; $pag_ant <= $pagina - 1; $pag_ant++){
                ...
                <li class="page-item">
                    <a class="btn btn-outline-success"
                        href='<?php echo "dashboard.php?pagina=$pag_ant" ?>'><?php echo $pag_ant ?></a>
                </li>
                <?php
                  }
              }
                ...
                <li class="page-item" aria-current="page">
                    <a class="btn btn-success-primary"
                        href='<?php echo "dashboard.php?pagina=$pagina" ?>'><?php echo $pagina ?></a>
                </li>
                <?php
                ...
                <li class="page-item">
                    <a class="btn btn-outline-success"
                        href='<?php echo "dashboard.php?pagina=$pag_dep"?>'><?php echo $pag_dep ?></a>
                </li>
          ...
          ?>
                ...
                <li class="page-item">
                    <a class="btn btn-success-primary"
                        href='<?php echo "dashboard.php?pagina=$quantidade_pg" ?>'>Ultima</a>
                </li>
            </ul>
        </nav>
    </div>
...
if(isset($_SESSION['msg-success'])){
    // Define um ID único para a mensagem de sucesso
