...
if(isset($_GET['id_editar']))
{
  ...
  $res = $p->buscarDadosusuarios($id_editar);
}
    ...
    if(isset($_POST['email']))
    {
        ...
        if(isset($_GET['id_editar']) && !empty($_GET['id_editar']))
        {
            ...
            {
                $p->atualizarAdm($id_edit, $nome, $login, $email);
...
<div class="container">
        <div class="row justify-content-center">
            <div class="col-auto">
                <h1 class="text mb-3 mt-3">Editar Administrador</h1>
            </div>
        </div>
            ...
            <div class="col-lg-6">
                <form method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="login" class="form-control" placeholder="Login" value="<?php if(isset($res)){echo $res['login'];}?>">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <input type="submit" name="atualizar" id="atualizar" class="btn btn-success" value="<?php if(isset($res)){echo "atualizar";}else{echo "cadastrar";}?>">
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-auto">
                <a class="link_voltar" href="buscar_adm.php">
                <button class="voltar">
                < Voltar
