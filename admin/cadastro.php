    ...
    <div class="col-lg-6">
        <form method="POST" action="./cad.php">
            ...
            <div class="mb-2 mt-0">
                ...
                <input type="number" name="ramal" class="form-control" placeholder="Ramal" value="<?php echo isset($_SESSION['ramal_digitado']) ? $_SESSION['ramal_digitado'] : ''; ?>">
            </div>
            <div class="mb-3">
                <label for="email" class="form-label">Email</label>
                <input type="text" name="email" class="form-control" placeholder="Email" value="<?php echo isset($_SESSION['email_digitado']) ? $_SESSION['email_digitado'] : ''; ?>">
            </div>
            <div class="mb-3">
                <label for="area" class="form-label">Área</label>
                <input type="text" name="area" class="form-control" placeholder="Área" value="<?php echo isset($_SESSION['area_digitado']) ? $_SESSION['area_digitado'] : ''; ?>">
            </div>
            <div class="mb-3">Unidade
            <select name="unidade" class="form-select" aria-label="Default select example" value="<?php echo isset($_SESSION['unidade_digitado']) ? $_SESSION['unidade_digitado'] : ''; ?>">
                <option selected>Vista Alegre</option>
                <option >Aporé</option>
            </select>
            <div class="mt-3 mb-3">
...
if(isset($_SESSION['msg-success'])){
    ...
    echo '    </div>';
    echo '    <div class="success__close" onclick="closeMessage(\''.$success_id.'\')"><svg xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 20 20" height="20"><path fill="#393a37" d="m15.8333 5.34166-1.175-1.175-4.6583 4.65834-4.65833-4.65834-1.175 1.175 4.65833 4.65834-4.65833 4.6583 1.175 1.175 4.65833-4.6583 4.6583 4.6583 1.175-1.175-4.6583-4.6583z"></path></svg></div>';
    echo '</div>';
